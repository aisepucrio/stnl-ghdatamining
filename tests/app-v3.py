...
def get_issues(repo_name, headers):
    ...
    } for issue in issues if 'number' in issue and 'title' in issue and 'state' in issue and 'user' in issue and 'login' in issue['user']]
...
def get_pull_requests(repo_name, headers):
    ...
    } for pr in pull_requests if 'number' in pr and 'title' in pr and 'state' in pr and 'user' in pr and 'login' in pr['user']]
